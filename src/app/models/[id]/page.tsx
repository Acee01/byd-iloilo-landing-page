  ...
  return (
    <div className="min-h-screen bg-black pb-24 md:pb-0">
          ...
          <div className="max-w-full mx-auto px-6 lg:container">
            <div className="flex items-center justify-center md:justify-between h-14">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button
                  className="hidden md:inline-flex items-center gap-2 bg-white text-black px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
                  style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.875rem)" }}
                >
                  Get A Quote
                </button>
      ...
      <section id="overview" className="relative z-10">
        <div className="relative min-h-[100vh] lg:min-h-[40vh] p-10 overflow-hidden border border-white/10">
          ...
          <div className="absolute inset-0 [background:radial-gradient(100%_60%_at_85%_20%,rgba(255,255,255,0.18)_0%,rgba(0,0,0,0)_60%)] mix-blend-overlay opacity-30" />
          ...
          <div className="relative h-full w-full">
            <div className="container mx-auto h-full flex items-end pb-10 lg:items-center lg:pb-0">
              <div className="w-full max-w-2xl flex flex-col gap-5">
                ...
                <p
                  className="text-white/90 max-w-xl tracking-wide"
                  style={{
                ...
                <div className="flex gap-2">
                  <span
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full font-medium text-white/90 bg-white/10 border border-white/15 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.15)]"
                    style={{ fontSize: "clamp(0.625rem, 1.2vw, 0.75rem)" }}
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <div>
                    <Link href="#">
                      <button
                        className="relative w-full group/btn rounded-xl px-4 py-3 font-medium text-white/90 bg-white/10 backdrop-blur-md border border_white/15 shadow-[inset_0_1px_0_rgba(255,255,255,0.15)] hover:bg-white/15 hover:border-white/25 hover:shadow-[0_8px_30px_rgba(255,255,255,0.08)] transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40 active:scale-[0.99]"
                        style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.875rem)" }}
                      >
                        <span
                  ...
                  <div>
                    <Link href="/get-a-quote">
                      <button
                        className="relative w-full group/btn rounded-xl px-4 py-3 font-medium text-black bg-white hover:bg-white/90 border border-white/10 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40 active:scale-[0.99]"
                        style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.875rem)" }}
                      >
                        <span
        ...
        <div className="container mx-auto">
          ...
          <header className="relative z-10 pt-20 pb-16 px-4 sm:px-6 md:px-8">
            <div className="container mx-auto text-center">
              <h1
                className="font-bold italic mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-white/85 to-white/60"
      ...
      <section id="specs" className="relative z-10 px-4 sm:px-6 md:px-8 pb-20">
        <div className="container mx-auto">
          <h2
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-md border-t border-white/10 md:hidden transition-all duration-300">
        <div className="max-w-full mx-auto px-4 py-3 flex items-center justify-between gap-3">
          ...
          <button
            className="inline-flex items-center justify-center gap-2 bg-white text-black px-4 py-2.5 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            style={{ fontSize: "clamp(0.75rem, 1.5vw, 0.875rem)" }}
          >
            Get A Quote
          </button>
